...
raw_upload:	$(TARGET_HEX)
		$(AVRDUDE_SUDO) $(AVRDUDE) $(AVRDUDE_COM_OPTS) $(AVRDUDE_ARD_OPTS) -U flash:w:$(TARGET_HEX):i -U flash:v:$(TARGET_HEX):i
...
ispload:	$(TARGET_HEX)
		-if [ "$(AVRDUDE_UNLOAD_FTDI)" ]; then sudo kextunload /System/Library/Extensions/FTDIUSBSerialDriver.kext; fi
		$(AVRDUDE_SUDO) $(AVRDUDE) $(AVRDUDE_COM_OPTS) $(AVRDUDE_ISP_OPTS) -B 1 -e \
			-U lock:w:$(ISP_LOCK_FUSE_PRE):m \
			-U hfuse:w:$(ISP_HIGH_FUSE):m \
			-U lfuse:w:$(ISP_LOW_FUSE):m \
			-U efuse:w:$(ISP_EXT_FUSE):m
		$(AVRDUDE_SUDO) $(AVRDUDE) $(AVRDUDE_COM_OPTS) $(AVRDUDE_ISP_OPTS) -D -U flash:w:$(TARGET_HEX):i -U flash:v:$(TARGET_HEX):i
#		$(AVRDUDE_SUDO) $(AVRDUDE) $(AVRDUDE_COM_OPTS) $(AVRDUDE_ISP_OPTS) \
#			-U lock:w:$(ISP_LOCK_FUSE_POST):m
		if [ "$(AVRDUDE_UNLOAD_FTDI)" ]; then sudo kextload /System/Library/Extensions/FTDIUSBSerialDriver.kext; fi
