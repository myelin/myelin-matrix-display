...
/**
 * This sketch emulates the Myelin Matrix Display, a 25 x 12
 * RGB LED sign.
 *
 * It listens on port 58082 for UDP packets.  The first byte
 * of the packet must be 1, then the next 900 bytes contain
 * color data in RGB order, from left to right, top to bottom.
 *
 * Copyright (C) 2012-2016 Phillip Pearson
 * Copyright (C) 2010 Justin Day
